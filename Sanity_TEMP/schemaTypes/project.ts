...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: "aiContext",
      title: "AI Context (Technical Deep Dive)",
      type: "object",
      description: "Hidden context for the AI Agent to explain this project effectively",
      fields: [
        {
        ...
        },
        {
          ...
          type: "text",
          rows: 3,
          description: "What were the hard parts?",
        },
        {
          name: "solutionsAndDecisions",
          title: "Solutions & Decisions",
          type: "text",
          rows: 4,
          description: "Why did you choose this architecture/stack?",
        },
        {
          name: "impact",
          ...
          type: "text",
          rows: 3,
          description: "What did this project achieve?",
        },
        {
